...
#define	TEXTURE_FRAME_SCORE	"data/TEXTURE/score_frame.png"	// 読み込むテクスチャファイル名
...
HRESULT MakeVertexScore(LPDIRECT3DDEVICE9 pDevice)
{
	...
	{//頂点バッファの中身を埋める
		...
		{
			// 頂点座標の設定
			pVtx[0].vtx = D3DXVECTOR3(SCORE_POS_X - 15, SCORE_POS_Y-20, 0.0f);
			pVtx[1].vtx = D3DXVECTOR3(SCORE_POS_X + (SCORE_INTERVAL_X + SCORE_SIZE_X) * NUM_PLACE + 15, SCORE_POS_Y-20, 0.0f);
