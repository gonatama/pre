...
#define BUTTON_A		0x00000010l	// Ａボタン(.rgbButtons[0]&0x80)PS4　■
#define BUTTON_B		0x00000020l	// Ｂボタン(.rgbButtons[1]&0x80)PS4　×
#define BUTTON_C		0x00000040l	// Ｃボタン(.rgbButtons[2]&0x80)PS4　〇
